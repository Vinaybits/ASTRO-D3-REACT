...
const nextDay = () => {
  this.context.set_Panchang_Date(contextType.panchangDate,contextType.placeobserved);
}
         ...
         <DashboardTopBar/>
            ...
            <div className="row" style={{paddingTop:"20px"}}>
              <div className="col-md-12 col-xl-12">
                <div className="card-box" style={{ "padding": "10px", backgroundImage: `url(${background})`, width:"100%", height:"75%", marginBottom:"0px", boxShadow: "10px 10px 10px #333"}}>
                    <div className="card" style={{ background:"none", fontSize:"0.9rem"}} >
                    ...
                    <div className="dpPHeaderRightTitle"><u>{day} {month_string}</u><i onClick={handleCalendar} style={{"fontSize":"20px", "marginLeft":"4%","cursor":"pointer"}} className="dpPHeaderRightTitle fa">&#xf073;</i></div>
                      <div className="dpPHeaderRightTitle"><u>{place}</u> <img  onClick={handleCalendar} src={require('../assets/img/map.png')} alt="Map" className="MapIcon"/></div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="card-box">
                  <div className="tablesaw-bar tablesaw-mode-stack"></div>
                  <table
                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="td2">
                          <span className="tablevalue"><img src={require('../assets/img/sunrise.png')} alt="Sunrise" className="TableIcon"/>{sunriseTimedisplay}</span>
                        </td>
                        <td className="td3">
                          <p className="tablelabel">Sun Set</p> {" "}
                        </td>
                        <td className="td4">
                          <span className="tablevalue"><img src={require('../assets/img/sunset.png')} alt="Sunset" className="TableIcon"/>{sunsetTimedisplay}</span>
                        </td>
                      </tr>
                      <tr className="lastrow">
                        ...
                        <td className="td2">
                          <span className="tablevalue"><img src={require('../assets/img/moonrise.png')} alt="MoonRise" className="TableIcon"/>{moonriseTimedisplay}</span>
                        </td>
                        <td className="td3">
                          <p className="tablelabel">Moon Set</p> 
                        </td>
                        <td className="td4">
                          <span className="tablevalue"><img src={require('../assets/img/moonset.png')} alt="Moonset"className="TableIcon"/>{moonsetTimedisplay}</span>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="td2">
                          <span className="tablevalue">{tithinext}</span>
                        </td>
                        <td className="td3">
                          <p className="tablelabel"></p> 
                        ...
                        <td className="td4">
                          <span className="tablevalue">{karannext}</span>
                        </td>
                      </tr>
                      <tr>
                        <td className="td1">
                        ...
                        <td className="td4">
                          <span className="tablevalue">{karan_next_next}</span>
                        </td>
                      </tr>
                      <tr>
                        <td className="td1">
                        ...
                        <td className="td2">
                          <span className="tablevalue">{yoganext}</span>
                        </td>
                        <td className="td3">
