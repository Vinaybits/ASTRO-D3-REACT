...
import './styles.css';
// import './patternfly/timeline.css';
// import './patternfly/style.css';
// import './patternfly/patternfly.min.css';
// import './patternfly/patternfly-additions.min.css';
import 'bootstrap-select';
import $ from 'jquery';
const json = require('./timeline/d.json');
...
//             return t.hasOwnProperty("events") ? "" : "";
//           },
//           eventPopover: function (t) {
//             var e = "";
//             if (t.hasOwnProperty("events"))
//               e = "Group of " + t.events.length + " events";
//             else {
//               for (var n in t.details)
//                 e =
//                   e +
...
//           eventGrouping: 6e4,
//         };
//       (o.dateFormat = o.locale
//         ? o.locale.timeFormat("%a %x %I:%M %p")
//         : r["default"].time.format("%a %x %I:%M %p")),
//         (t.exports = o);
//     },
//     function (t, e, n) {
//       "use strict";
...
//               .enter()
//               .append("g")
//               .classed("timeline-pf-x-axis", !0)
//               .classed(e, !0)
//               .call(r["default"](i, n))
//               .attr(
//                 "transform",
//                 "translate(0," +
//                   ("focus" === e ? a.height : a.height + a.ctxHeight + 40) +
//                   ")"
//               ),
//               o.call(r["default"](i, n, a.width)),
//               o.exit().remove();
//           };
...
//         for (var l in a) {
//           var s = new Date();
//           s.setTime(+l), n.push({ date: s, count: a[l] });
//         }
//       }
//       Object.defineProperty(e, "__esModule", { value: !0 });
//       var r = n(1),
...
//         var l = t
//             .append("g")
//             .classed("timeline-pf-context", !0)
//             .attr("width", n.width)
//             .attr("height", n.ctxHeight)
//             .attr("clip-path", "url(#timeline-pf-context-brush-clipper)")
//             .attr(
//               "transform",
//               "translate(" +
//                 (a.padding.left + a.labelWidth) +
//                 "," +
//                 (a.padding.top + n.height + 40) +
//                 ")"
//             ),
//           s = [],
//           d = 36e5,
//           u = Math.ceil(
//             (d / (e.ctx.domain()[1] - e.ctx.domain()[0])) * n.width
//           );
//         i(r, d, s),
//           s.sort(function (t, e) {
...
//           e.cty.domain([
//             0,
//             o["default"].max(s, function (t) {
//               return t.count;
//             }),
//           ]),
//           l
//             .selectAll(".timeline-pf-bar")
//             .data(s)
//             .enter()
//             .append("rect")
...
//               .enter()
//               .append("g")
//               .classed("timeline-pf-drop-line", !0)
//               .attr("transform", function (t, a) {
//                 return "translate(0, " + (e.y(a) + n.lineHeight / 2) + ")";
//               })
//               .attr("fill", n.eventLineColor),
//               i.each(function (t) {
//                 var a = d3
//                   .select(this)
//                   .selectAll(".timeline-pf-drop")
//                   .data(t.data);
...
//                   .enter()
//                   .append("text")
//                   .classed("timeline-pf-drop", !0)
//                   .classed("timeline-pf-event-group", function (t) {
...
//                   .attr("data-html", "true")
//                   .attr("data-content", n.eventPopover)
//                   .attr("dominant-baseline", "central")
//                   .text(n.eventShape);
//                 n.eventClick && i.on("click", n.eventClick),
//                   n.eventHover && i.on("mouseover", n.eventHover),
//                   a.exit().on("click", null).on("mouseover", null),
//                   a.exit().remove();
//               }),
//               i.exit().remove();
//           };
...
//           .attr("width", e.width)
//           .attr("height", 2 * a.lineHeight)
//           .attr("patternUnits", "userSpaceOnUse");
//         r.append("rect").attr("width", e.width).attr("height", a.lineHeight),
//           r
//             .append("line")
//             .attr("x1", 0)
//             .attr("x2", e.width)
//             .attr("y1", a.lineHeight)
//             .attr("y2", a.lineHeight),
//           r
//             .append("line")
//             .attr("x1", 0)
//             .attr("x2", e.width)
...
//           d = t
//             .append("g")
//             .classed("timeline-pf-labels", !0)
//             .attr(
//               "transform",
//               "translate(" + a.padding.left + ", " + a.padding.top + ")"
//             ),
//           c = t
//             .append("g")
//             .classed("timeline-pf-axes", !0)
//             .attr(
//               "transform",
//               "translate(" +
//                 (a.padding.left + a.labelWidth) +
...
//           p = t
//             .append("g")
//             .classed("timeline-pf-drops-container", !0)
...
//           var h = t
//             .append("g")
//             .classed("timeline-pf-timestamp", !0)
//             .attr("height", 30)
//             .attr(
//               "transform",
//               "translate(" +
...
//                 .enter()
//                 .append("text")
//                 .classed("timeline-pf-label", !0)
//                 .attr("transform", function (t, a) {
//                   return (
//                     "translate(" +
//                     (n.labelWidth - 20) +
//                     " " +
//                     (e.y(a) + n.lineHeight / 2) +
//                     ")"
//                   );
//                 })
//                 .attr("dominant-baseline", "central")
...
//           l.attr("transform", "translate(" + e + ")"),
//             d.attr("transform", "translate(" + (e - 75) + ", -25)"),
//             u
//               .attr("transform", "translate(" + e + ", -9)")
//               .text(i(n.x.invert(e)));
//         }
//         t.append("rect")
//           .attr("width", a.width)
...
//             .append("text")
//             .text(i(s[1]))
//             .attr("transform", "translate(" + n.x.range()[1] + ")")
//             .attr("text-anchor", "middle");
//       };
//     },
//     function (t, e, n) {
...
//           t.each(function (e) {
//             var l = e;
//             (e = o(e, n.eventGrouping)),
//               (n.lineHeight = e.length <= 3 ? 80 : 40),
//               (n.contextStart = n.contextStart || d["default"].min(r(e))),
//               (n.contextEnd = n.contextEnd || n.end),
//               d["default"].select(this).select(".timeline-pf-chart").remove(),
//               d["default"].select(this).selectAll(".timeline-pf-zoom").remove();
//             var u = 40,
...
//                 .select(this)
//                 .append("svg")
//                 .classed("timeline-pf-chart", !0)
//                 .attr({ width: c, height: p.outer_height }),
//               x = m["default"](g, p, h, n).bind(t);
//             x(e),
//               n.context && v["default"](g, h, p, n, l),
//               a.updateZoom(d["default"].select(this), p, h, n, e, x);
//           });
//         }
//         var e =
...
//             (n = Math.round(t[r].data[o].date / e) * e),
//               void 0 === a[n] && (a[n] = []),
//               a[n].push(t[r].data[o]);
//           for (var l in a)
...
//             else {
//               var s = new Date();
//               s.setTime(+l), i[r].data.push({ date: s, events: a[l] });
//             }
//           a = {};
//         }
//         return i;
...
//         x = n(11),
//         b = a(x);
//       (d["default"].chart = d["default"].chart || {}),
//         (d["default"].chart.timeline = i),
//         (t.exports = i);
//     },
//     function (t, e, n) {
//       "use strict";
...
//             }),
//             i = e.locale
//               ? e.locale.timeFormat.multi(a)
//               : r["default"].time.format.multi(a),
//             o = Math.round(n / 70),
//             l = r["default"].svg
//               .axis()
//               .scale(t)
...
//                     (this.grid = l["default"].select(".timeline-pf-grid")),
//                     (this.dimensions = e),
//                     (this.scales = n),
//                     (this.configuration = a),
//                     (this.data = i),
//                     (this.callback = r),
//                     (this.sliderScale = l["default"].scale
//                       .log()
//                       .domain([a.minScale, a.maxScale])
//                       .range([a.minScale, a.maxScale])
//                       .base(2)),
//                     (this.zoom = l["default"].behavior
//                       .zoom()
...
//                       .attr(
//                         "class",
//                         "btn btn-default timeline-pf-zoom timeline-pf-zoom-in"
//                       )
//                       .attr("id", "timeline-pf-zoom-in")
//                       .style("top", a.padding.top + "px")
//                       .on("click", function () {
//                         o.zoomClick();
//                       });
//                     s.style(
...
//                         a.labelWidth +
//                         e.width +
//                         (a.sliderWidth - s.node().offsetWidth) +
//                         "px"
//                     )
//                       .append("i")
...
//                       .style("top", a.padding.top + e.height - 26 + "px")
//                       .on("click", function () {
//                         o.zoomClick();
//                       });
//                     d.style(
...
//                         a.labelWidth +
//                         e.width +
//                         (a.sliderWidth - d.node().offsetWidth) +
//                         "px"
//                     )
//                       .append("i")
...
//                       .style(
//                         "width",
//                         e.height - 2 * s.node().offsetHeight + "px"
//                       )
...
//                       "top",
//                       a.padding.top +
//                         (e.height - 2 * s.node().offsetHeight) / 2 +
//                         s.node().offsetHeight -
//                         u.node().offsetHeight / 2 +
//                         "px"
//                     ).style(
//                       "left",
//                       a.padding.left +
...
//                         e.width +
//                         a.sliderWidth -
//                         (s.node().offsetWidth - u.node().offsetHeight) / 2 -
//                         u.node().offsetWidth / 2 +
//                         "px"
//                     );
//                   }
//                   return (
//                     a.context &&
//                       ((this.brush = l["default"].svg
//                         .brush()
//                         .x(n.ctx)
//                         .extent(n.x.domain())
//                         .on("brush", function () {
...
//                         })),
//                       t
//                         .select(".timeline-pf-brush")
//                         .call(this.brush)
//                         .selectAll("rect")
//                         .attr("height", e.ctxHeight)),
//                     a.eventZoom && this.zoom.on("zoomend", a.eventZoom),
...
//                         a.slider &&
//                           t
//                             .select("#timeline-pf-slider")
//                             .property("value", o.sliderScale(o.zoom.scale())),
//                         a.context &&
//                           (o.brush.extent(o.scales.x.domain()),
//                           t.select(".timeline-pf-brush").call(o.brush));
//                     }),
...
//                     r = void 0,
//                     o = void 0,
//                     s = { x: this.zoom.translate()[0], k: this.zoom.scale() };
...
//                       e = this.sliderScale.invert(
//                         l["default"].event.target.value
//                       );
//                       break;
//                     default:
//                       e = this.zoom.scale();
...
//                     (o = r * s.k + s.x),
//                     (s.x += a - o),
//                     this.interpolateZoom([s.x, 0], s.k, n);
//                 },
//               },
//               {
//                 key: "interpolateZoom",
...
//                         return function (t) {
//                           a.zoom.scale(i(t)).translate(n(t)),
//                             a.zoom.event(a.grid);
//                         };
//                       }
//                     });
...
//                     u = void 0;
//                   (s *= this.getScale(
//                     this.getRange(this.scales.x.domain()),
//                     a
//                   )),
//                     s < r[0] ? (s = r[0]) : s > r[1] && (s = r[1]),
//                     (u = (this.scales.x.domain()[0] - t) * (i / d)),
//                     (o += u),
//                     (o *= s / l),
//                     this.interpolateZoom([o, 0], s, n);
//                 },
//               },
//             ]),
//             t
