        ...
        apidate_format =() =>{
           ...
           // console.log("Dates " + minDate + "-" + (date_end) +"---- " + maxDate);
            ...
            var sun_data = {
              ...
              var trace3 = {
              x:[x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1],x_dates[x_dates.length-1]],  
              y:[6.66,19.98,33.32,46.65,59.98,73.31,86.64,99.97,113.3,126.63,139.96,153.29,166.62,179.95,193.28,206.61,219.94,233.27,246.6,259.93,273.26,286.59,299.92,313.25,326.58,339.91,353.24],
              text:["Ashwini","Bharani","Krittika", "Rohini", "Mrigashīrsha", "Ārdrā", "Punarvasu", "Pushya", "Āshleshā", "Maghā", "Pūrva", "Uttara","Hasta","Chitra","Svātī","Viśākhā","Anurādhā","Jyeshtha","Mula","P.Āshādhā","U.Āṣāḍhā","Śrāvaṇa","Śrāviṣṭha","Shatabhisha","P.Bhādrapadā","U.Bhādrapadā","Revati"],
              mode:"text",
              name:"NAKS",
              type:"scatter"
               //yaxis: 'y2',
...
<div class="btn-group">
<button className="btn btn-primary" onClick={this.switch_view}> switch view</button>
